...
from db import db
from init_db import init_defaults
from resources.user import UserAccount
from resources.account import Account, AccountSingular, AccountUser
...
api.add_resource(AccountUser, '/users/account/<int:account_id>')
